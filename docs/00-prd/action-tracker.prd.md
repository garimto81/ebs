...
stateDiagram-v2
    ...
    note right of HAND_COMPLETE : 통계 갱신, 히스토리 저장
...
> ![AT 메인 화면 레이아웃](../02-design/mockups/v3/ebs-at-main-layout.png)
...
> ![AT 설정/구성 뷰](../02-design/mockups/v3/ebs-at-settings-view.png)
...
> ![수동 카드 선택 모달](../02-design/mockups/v3/ebs-at-card-selector.png)
...
> ![플레이어 통계 패널](../02-design/mockups/v3/ebs-at-stats-panel.png)
...
> ![RFID 카드 등록 모달](../02-design/mockups/v3/ebs-at-rfid-register.png)
...
> ![AT 전체 레이아웃](../02-design/mockups/v3/ebs-at-full-layout.png)
...
> ![좌석 셀 구성](../02-design/mockups/v3/ebs-at-seat-cell.png)
