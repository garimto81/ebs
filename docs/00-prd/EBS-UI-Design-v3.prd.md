...
방송 카메라가 한쪽에서 촬영하는 환경에 최적화. 플레이어가 상단 반원에만 배치된다.

> ![템플릿 C: 반원형 좌석 배치](../02-design/mockups/v3/ebs-seat-template-c.png)
> *템플릿 C: 반원형(Semicircle) — 방송 카메라 최적화*
...
#### 3.3.5 템플릿 D: 직사각형 (Rectangular)

파이널 테이블/헤즈업 방송에서 사용. 양쪽이 대칭인 레이아웃.

> ![템플릿 D: 직사각형 좌석 배치](../02-design/mockups/v3/ebs-seat-template-d.png)
> *템플릿 D: 직사각형(Rectangular) — 파이널 테이블/헤즈업*
