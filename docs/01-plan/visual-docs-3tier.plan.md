...
| # | 크롭 이미지 | 기능명 |
|:-:|:-----------:|--------|
| 1 | ![01](03_Cropped_ngd/01-main-window/01-main-window-crop-01.png) | Title Bar |
| 2 | ![02](03_Cropped_ngd/01-main-window/01-main-window-crop-02.png) | Preview |
...
```

- 경로 형식: `03_Cropped_ngd/{screen-id}/{screen-id}-crop-{lbl}.png` (상대 경로, `PokerGFX-UI-Analysis.md` 기준)
...
- 이미지 경로 상대 경로 형식 일관성 (`03_Cropped_ngd/...`)
