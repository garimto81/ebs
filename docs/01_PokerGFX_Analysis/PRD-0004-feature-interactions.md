...
> 이 문서는 PRD-0004-EBS-Server-UI-Design.md의 **175개 UI 요소**에 대한 상세 인터랙션 명세이다.
>
...
5개 탭(I/O · GFX · Rules · Display · System) 네비게이션 바. 탭 클릭 시 해당 탭으로 전환. M-07 Lock Toggle 활성 시 탭 전환은 가능하나 각 탭 내부 설정 변경은 불가.
...
**비활성 조건**: Delay Pipeline 비활성(v2.0 이전) 시 전체 비활성. S-00 Fill & Key 외 모드 시 O-07 비활성.
...
**Version**: 1.3.0 | **Updated**: 2026-03-03