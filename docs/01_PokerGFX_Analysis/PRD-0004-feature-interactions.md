...
source_docs:
  - ref: "PRD-0004"
    path: "docs/00-prd/EBS-UI-Design.md"
    desc: "UI 설계서 (180개 요소 정의)"
  - ref: "TechSpec"
...
> 이 문서는 EBS-UI-Design.md의 **180개 UI 요소**에 대한 상세 인터랙션 명세이다.
>
...
| 문서 | 역할 |
|------|------|
| [EBS-UI-Design.md](../00-prd/EBS-UI-Design.md) | UI 레이아웃 + Element Catalog (요소 정의) |
