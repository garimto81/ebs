...
> 원본 캡쳐: [Main Window - PokerGFX 원본](02_Annotated_ngd/01-main-window.png)
...
Sources와 Outputs를 단일 탭으로 통합한 입출력 파이프라인 설정 화면. 2섹션: Input(상단) + Output(하단). Output Mode Selector(S-00)가 탭 최상단에 위치하여 Fill & Key / Chroma Key / Internal 모드를 선택하면 하위 항목 조건부 표시.

> 오버레이: [Sources 탭](../../images/overlays/gfx_sources2.jpg) · [Outputs 탭](../../images/overlays/gfx_outputs2.jpg)
...
> **Drop**: S-05~S-06(Board Cam Hide GFX/Auto Camera Control), S-09~S-10(Follow Players/Board), S-15~S-16(Board Sync/Crossfade), S-17~S-18(Audio Input Source/Audio Sync), S-19~S-24(추가 감축)
...
> 오버레이: [GFX 1 탭](../../images/overlays/gfx_gfx1_2.jpg)
...
> 오버레이: [GFX 2 탭](../../images/overlays/gfx_gfx2_2.jpg)
...
> 오버레이: [GFX 3 탭](../../images/overlays/gfx_gfx3_2.jpg)
...
> 오버레이: [System 탭](../../images/overlays/gfx_system1.jpg)
